...
fprintf(stuerr,"\tDX(%u,%u,%u) DY(%u,%u,%u) PREC(%u,%u,%u) SIGNED(%u,%u,%u)\n",
...
#ifdef DEBUG_NUMCOMPS
fprintf(stderr,"%s:%d:\n\tTRACE numcomps(%u) color_space(%d)\n",
...
#ifdef OPJ_CLRSPC_CIELAB
	else
	if(l_image->color_space == OPJ_CLRSPC_CIELAB)
  {
#if defined(OPJ_HAVE_LIBLCMS1) || defined(OPJ_HAVE_LIBLCMS2)
	COLOR_cielab_to_rgb(l_image, &dst);
#endif
  }
#endif
